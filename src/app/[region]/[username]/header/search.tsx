...
export default function Page() {
	...
	return (
		<div className="flex flex-row items-center gap-4 py-2 px-4">
			...
			<form id="search-summoner" className="flex flex-row gap-[0.125rem]" onSubmit={onSubmit}>
				<div>
					<div className="flex flex-col gap-1">
						<input
							...
							className="w-full h-12 rounded-l bg-gray-700 text-center text-xl placeholder-gray-400 focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-gray-500"
						/>
				...
				<button
					...
					type="submit"
					className="h-12 w-8 p-1 rounded-r align-middle hover:bg-gray-600 bg-gray-700"
				>
