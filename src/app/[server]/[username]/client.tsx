						...
						<div className="flex flex-col gap-6 ">
							<div>
								...
								<div className="text-sm">
									Tailored for the challenge <span className="italic font-bold">Catch &apos;em all</span>, but also
									works with <span className="italic font-bold">Master yourself</span> and{" "}
